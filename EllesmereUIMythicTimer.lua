...
-- Pool of progress bar textures (for enemy forces)
local progBars = {}
local function GetProgBar(parent, key)
    if progBars[key] then return progBars[key] end
    local t = parent:CreateTexture(nil, key == "fill" and "ARTWORK" or "BACKGROUND")
    progBars[key] = t
    return t
end
